...
//! typename    org.apache.arrow.flatbuf.Decimal
//!
...
pub const Decimal = struct {
    ...
    pub fn GetRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.Decimal {
        const n = fb.encode.read(u32, buf[offset..]);
        return org.apache.arrow.flatbuf.Decimal.init(buf, n + offset);
    }

    pub fn GetSizePrefixedRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.Decimal {
        const n = fb.encode.read(u32, buf[offset + fb.Builder.size_u32 ..]);
        return org.apache.arrow.flatbuf.Decimal.init(buf, n + offset + fb.Builder.size_u32);
    }
...
test {
    ...
    var obj_packed = Decimal.GetRootAs(bytes, 0);
