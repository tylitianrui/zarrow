...
//! typename    org.apache.arrow.flatbuf.Timestamp
//!
...
pub const TimestampT = struct {
    unit: org.apache.arrow.flatbuf.TimeUnit = @as(org.apache.arrow.flatbuf.TimeUnit, @enumFromInt(0)),
...
pub const Timestamp = struct {
    ...
    pub fn GetRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.Timestamp {
        const n = fb.encode.read(u32, buf[offset..]);
        return org.apache.arrow.flatbuf.Timestamp.init(buf, n + offset);
    }

    pub fn GetSizePrefixedRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.Timestamp {
        const n = fb.encode.read(u32, buf[offset + fb.Builder.size_u32 ..]);
        return org.apache.arrow.flatbuf.Timestamp.init(buf, n + offset + fb.Builder.size_u32);
    }
    ...
    pub fn Unit(rcv: Timestamp) org.apache.arrow.flatbuf.TimeUnit {
        const o = rcv._tab.offset(4);
        if (o != 0) {
            return rcv._tab.read(org.apache.arrow.flatbuf.TimeUnit, o + rcv._tab.pos);
        }
        return @as(org.apache.arrow.flatbuf.TimeUnit, @enumFromInt(0));
    }

    pub fn MutateUnit(rcv: Timestamp, n: org.apache.arrow.flatbuf.TimeUnit) bool {
    ...
    pub fn AddUnit(__builder: *Builder, unit: org.apache.arrow.flatbuf.TimeUnit) !void {
        try __builder.prependSlot(org.apache.arrow.flatbuf.TimeUnit, 0, unit, @as(org.apache.arrow.flatbuf.TimeUnit, @enumFromInt(0)));
    }
...
test {
    ...
    var obj_packed = Timestamp.GetRootAs(bytes, 0);
