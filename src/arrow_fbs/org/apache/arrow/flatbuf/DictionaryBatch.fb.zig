...
//! typename    org.apache.arrow.flatbuf.DictionaryBatch
//!
...
pub const DictionaryBatchT = struct {
    id: i64 = 0,
    data: ?*org.apache.arrow.flatbuf.RecordBatchT = null,
    ...
    pub fn UnpackTo(rcv: DictionaryBatch, t: *DictionaryBatchT, __pack_opts: fb.common.PackOptions) !void {
        ...
        if (rcv.Data()) |x| {
            if (t.data == null) {
                t.data = try __pack_opts.allocator.?.create(org.apache.arrow.flatbuf.RecordBatchT);
                t.data.?.* = .{};
            }
            try org.apache.arrow.flatbuf.RecordBatchT.UnpackTo(x, t.data.?, __pack_opts);
        }
...
pub const DictionaryBatch = struct {
    ...
    pub fn GetRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.DictionaryBatch {
        const n = fb.encode.read(u32, buf[offset..]);
        return org.apache.arrow.flatbuf.DictionaryBatch.init(buf, n + offset);
    }

    pub fn GetSizePrefixedRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.DictionaryBatch {
        const n = fb.encode.read(u32, buf[offset + fb.Builder.size_u32 ..]);
        return org.apache.arrow.flatbuf.DictionaryBatch.init(buf, n + offset + fb.Builder.size_u32);
    }
    ...
    pub fn Data(rcv: DictionaryBatch) ?org.apache.arrow.flatbuf.RecordBatch {
        const o = rcv._tab.offset(6);
        if (o != 0) {
            const x = rcv._tab.indirect(o + rcv._tab.pos);
            return org.apache.arrow.flatbuf.RecordBatch.init(rcv._tab.bytes, x);
        }
        return null;
    }
...
test {
    ...
    var obj_packed = DictionaryBatch.GetRootAs(bytes, 0);
