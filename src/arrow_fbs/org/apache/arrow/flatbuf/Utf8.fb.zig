...
//! typename    org.apache.arrow.flatbuf.Utf8
//!
...
pub const Utf8 = struct {
    ...
    pub fn GetRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.Utf8 {
        const n = fb.encode.read(u32, buf[offset..]);
        return org.apache.arrow.flatbuf.Utf8.init(buf, n + offset);
    }

    pub fn GetSizePrefixedRootAs(buf: []u8, offset: u32) org.apache.arrow.flatbuf.Utf8 {
        const n = fb.encode.read(u32, buf[offset + fb.Builder.size_u32 ..]);
        return org.apache.arrow.flatbuf.Utf8.init(buf, n + offset + fb.Builder.size_u32);
    }
...
test {
    ...
    var obj_packed = Utf8.GetRootAs(bytes, 0);
